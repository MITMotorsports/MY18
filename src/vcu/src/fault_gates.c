...
void updateGateFaults() {
	...
	gate_faults.bms_fault = (HAL_GPIO_ReadPin(FAULT_GATES_PORT, BMS_FAULT_GATE_PIN) == GPIO_PIN_RESET);
	gate_faults.bpd_fault = (HAL_GPIO_ReadPin(FAULT_GATES_PORT, BPD_FAULT_GATE_PIN) == GPIO_PIN_RESET);
	gate_faults.imd_fault = (HAL_GPIO_ReadPin(FAULT_GATES_PORT, IMD_FAULT_GATE_PIN) == GPIO_PIN_RESET);
	gate_faults.sdn_fault = (HAL_GPIO_ReadPin(FAULT_GATES_PORT, SDN_FAULT_GATE_PIN) == GPIO_PIN_RESET);
	gate_faults.esd_fault = (HAL_GPIO_ReadPin(FAULT_GATES_PORT, ESD_FAULT_PIN) == GPIO_PIN_RESET);
}
