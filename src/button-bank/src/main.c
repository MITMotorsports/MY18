...
void GPIO_Init(void) {
    Chip_GPIO_SetPinDIRInput(LPC_GPIO, DRIVER_RESET_PIN_AND_PORT);
    Chip_GPIO_SetPinDIRInput(LPC_GPIO, RTD_PIN_AND_PORT);
    Chip_GPIO_SetPinDIRInput(LPC_GPIO, SCROLL_SELECT_PIN_AND_PORT);
